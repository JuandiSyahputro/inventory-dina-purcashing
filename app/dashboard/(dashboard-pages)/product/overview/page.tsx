...
const ProductPage = async ({ searchParams }: { searchParams?: Promise<{ [key: string]: string | undefined }> }) => {
  ...
  return (
    <div className="container p-10 mx-auto">
      ...
      <DataTable columns={isAdmin ? columnProduct : columnProductUser} dataProps={products.data} fetchData={fetchProductItems} elements={formAction} title="product code or name" />
    </div>
  );
};
