...
const VendorUpdate = ({ vendor, openDialog, setOpenDialog }: VendorUpdatedTypes) => {
      ...
      <DialogContent className="sm:max-w-[425px]">
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <DialogHeader>
            ...
            <DialogDescription>Update the vendor here. Click save when you&apos;re done.</DialogDescription>
          </DialogHeader>
...
export default memo(VendorUpdate);
